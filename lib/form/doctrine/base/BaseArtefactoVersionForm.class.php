...
/**
 * ArtefactoVersion form base class.
 *
 * @method ArtefactoVersion getObject() Returns the current form's model object
 *
 * @package    gestor
 * @subpackage form
 ...
 */
abstract class BaseArtefactoVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('artefacto_version[%s]');
