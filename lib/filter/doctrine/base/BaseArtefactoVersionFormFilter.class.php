...
/**
 * ArtefactoVersion filter form base class.
 *
 * @package    gestor
 * @subpackage filter
 ...
 */
abstract class BaseArtefactoVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('artefacto_version_filters[%s]');
