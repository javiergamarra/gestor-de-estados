...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'asignacion_id'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'asignacion_id'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function addVersionesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('AsignacionTrabajadores.version_id', $values)
    ;
  }
